...
--
-- Host: localhost:3306
-- Generation Time: Oct 24, 2021 at 10:39 PM
...
--
-- Table structure for table `notificationtableapplication`
--

CREATE TABLE `notificationtableapplication` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Indexes for table `notificationtableapplication`
--
ALTER TABLE `notificationtableapplication`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `notificationtableapplication`
--
ALTER TABLE `notificationtableapplication`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `operationsapplication`
  MODIFY `cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=658;
